...
rospy.init_node('simple_subscriber')                   # Initiate a Node called 'topic_subscriber'

sub = rospy.Subscriber('/car_velocity', Int32, callback)   # Create a Subscriber object that will listen to the /counter
