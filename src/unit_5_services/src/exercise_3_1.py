#! /usr/bin/env python
import rospkg # I am unsure about this 
import rospy # including the ros libray 
from iri_wam_reproduce_trajectory.srv import ExecTraj, ExecTrajRequest # I am unaware how to get this especially the ExecTrajRequest its very confusing 
#however the Exec Traj is found from rosservice info /execute_trajectory 
...
trajectory_file_path = rospack.get_path('iri_wam_reproduce_trajectory') + "/config/get_food.txt" # providing location to find the conifg 
