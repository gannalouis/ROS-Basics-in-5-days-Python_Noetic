...
(cl:defmethod cl:initialize-instance :after ((m <Age>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Age)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_age-msg:<Age> is deprecated: use robot_age-msg:Age instead.")))

(cl:ensure-generic-function 'years-val :lambda-list '(m))
(cl:defmethod years-val ((m <Age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_age-msg:years-val is deprecated.  Use robot_age-msg:years instead.")
  (years m))

(cl:ensure-generic-function 'months-val :lambda-list '(m))
(cl:defmethod months-val ((m <Age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_age-msg:months-val is deprecated.  Use robot_age-msg:months instead.")
  (months m))

(cl:ensure-generic-function 'days-val :lambda-list '(m))
(cl:defmethod days-val ((m <Age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_age-msg:days-val is deprecated.  Use robot_age-msg:days instead.")
  (days m))
