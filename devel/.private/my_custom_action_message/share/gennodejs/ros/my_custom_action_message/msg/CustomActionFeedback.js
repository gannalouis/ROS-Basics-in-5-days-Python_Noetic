...
let CustomFeedback = require('./CustomFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class CustomActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new CustomFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CustomFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CustomActionFeedback(null);
    ...
    data.feedback = CustomFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CustomActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = CustomFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new CustomFeedback()
    }
...
module.exports = CustomActionFeedback;
