...
"""autogenerated by genpy from my_custom_action_message/CustomActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class CustomActionFeedback(genpy.Message):
  _md5sum = "d5c85fe63e30a9136a0731dc693bc2e0"
  _type = "my_custom_action_message/CustomActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_custom_action_message/CustomFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CustomActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = my_custom_action_message.msg.CustomFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = my_custom_action_message.msg.CustomFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.return_value,) = _get_struct_f().unpack(str[start:end])
      return self
